...
$(function() {
    ...
    $("#aCod2").click(function () {
    	SwitchView("viewer");
		WriteViewer("http://webchat.quakenet.org/?nick=PCWFinderCom...&channels=cod2.wars%2Ccod.pracc");
		WriteTitles (
	...
	$("#aCod4").click(function () {
    	SwitchView("viewer");
		WriteViewer("http://webchat.quakenet.org/?nick=PCWFinderCom...&channels=cod4.wars%2Ccod.pracc");
		WriteTitles (
