...
$(function() {
    ...
    $("#aCs5v5").click(function () {
    	SwitchView("viewer");
		WriteViewer("http://webchat.quakenet.org/?nick=PCWFinderCom...&channels=pcw%2Cpraccnation%2Cpracc%2C5on5");
		WriteTitles (
    ...
    $("#aCs4v4").click(function () {
    	SwitchView("viewer");
		WriteViewer("http://webchat.quakenet.org/?nick=PCWFinderCom...&channels=pcw%2Cpraccnation%2Cpracc%2C4on4");
		WriteTitles (
    ...
    $("#aCs3v3").click(function () {
    	SwitchView("viewer");
		WriteViewer("http://webchat.quakenet.org/?nick=PCWFinderCom...&channels=pcw%2Cpraccnation%2Cpracc%2C3on3");
		WriteTitles (
    ...
    $("#aCs2v2").click(function () {
    	SwitchView("viewer");
		WriteViewer("http://webchat.quakenet.org/?nick=PCWFinderCom...&channels=pcw%2Cpraccnation%2Cpracc%2C2on2");
		WriteTitles (
    ...
    $("#aCsGerman").click(function () {
    	SwitchView("viewer");
		WriteViewer("http://webchat.quakenet.org/?nick=PCWFinderCom...&channels=5on5.de");
		WriteTitles (
