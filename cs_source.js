...
$(function() {
	...
	$("#aCsSource6v6").click(function () {
    	SwitchView("viewer");
		WriteViewer("https://webchat.quakenet.org/?nick=PCWFinderCom...&channels=s.pcw%2Ccss.europe%2Ccss.invite%2Cskilled.pcw%2C6on6.css");
		WriteTitles (
    ...
    $("#aCsSource5v5").click(function () {
    	SwitchView("viewer");
		WriteViewer("https://webchat.quakenet.org/?nick=PCWFinderCom...&channels=s.pcw%2Ccss.europe%2Ccss.invite%2Cskilled.pcw%2C5on5.css");
		WriteTitles (
    ...
    $("#aCsSource4v4").click(function () {
    	SwitchView("viewer");
		WriteViewer("https://webchat.quakenet.org/?nick=PCWFinderCom...&channels=s.pcw%2Ccss.europe%2Ccss.invite%2Cskilled.pcw%2C4on4.css");
		WriteTitles (
    ...
    $("#aCsSource3v3").click(function () {
    	SwitchView("viewer");
		WriteViewer("https://webchat.quakenet.org/?nick=PCWFinderCom...&channels=s.pcw%2Ccss.europe%2Ccss.invite%2Cskilled.pcw%2C3on3.css");
		WriteTitles (
    ...
    $("#aCsSource2v2").click(function () {
    	SwitchView("viewer");
		WriteViewer("https://webchat.quakenet.org/?nick=PCWFinderCom...&channels=s.pcw%2Ccss.europe%2Ccss.invite%2Cskilled.pcw%2C2on2.css");
		WriteTitles (
    ...
    $("#aCsSource1v1").click(function () {
    	SwitchView("viewer");
		WriteViewer("https://webchat.quakenet.org/?nick=PCWFinderCom...&channels=s.pcw%2Ccss.europe%2Ccss.invite%2Cskilled.pcw%2C1on1.css");
		WriteTitles (
    ...
    $("#aCsSourceFinland").click(function () {
    	SwitchView("viewer");
		WriteViewer("https://webchat.quakenet.org/?nick=PCWFinderCom...&channels=s.pcw%2Ccss.europe%2Ccss.invite%2Cfinland.css");
		WriteTitles (
    ...
    $("#aCsSourceNorway").click(function () {
    	SwitchView("viewer");
		WriteViewer("https://webchat.quakenet.org/?nick=PCWFinderCom...&channels=s.pcw%2Ccss.europe%2Ccss.invite%2Cnorge.css");
		WriteTitles (
    ...
    $("#aCsSourceSweden").click(function () {
    	SwitchView("viewer");
		WriteViewer("https://webchat.quakenet.org/?nick=PCWFinderCom...&channels=s.pcw%2Ccss.europe%2Ccss.invite%2Csweden.css");
		WriteTitles (
