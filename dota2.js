...
$(function() {
    ...
    $("#aDota2").click(function () {
    	SwitchView("viewer");
		WriteViewer("https://webchat.quakenet.org/?nick=PCWFinderCom...&channels=dota2%2Cdota2.cw");
		WriteTitles (
			"Dota 2 Channels",
			""
		);
    ...
    $("#aDota2Sweden").click(function () {
    	SwitchView("viewer");
		WriteViewer("https://webchat.quakenet.org/?nick=PCWFinderCom...&channels=dota2.swe");
		WriteTitles (
    ...
    $("#aDota2Finland").click(function () {
    	SwitchView("viewer");
		WriteViewer("https://webchat.quakenet.org/?nick=PCWFinderCom...&channels=dota2.fi");
		WriteTitles (
    ...
    $("#aDota2Norway").click(function () {
    	SwitchView("viewer");
		WriteViewer("https://webchat.quakenet.org/?nick=PCWFinderCom...&channels=dota2.no");
		WriteTitles (
